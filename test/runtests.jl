...
# !!! Main.UserApp is configured as an alias for Main.JlGenieQuantapp and you might encounter it in some tests
using Main.JlGenieQuantapp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JlGenieQuantapp tests" begin
  @includetests ARGS
end
